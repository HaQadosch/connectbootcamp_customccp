...
describe("SoftphoneManager", function() {
  describe("#SoftphoneManager RTC session", function() {
    var bus, contact, agent, status, contactId, RTCsession;
    ...
    before(function() {
      ...
      sinon
        .stub(connect.Conduit.prototype, "sendUpstream")
        .returns(function() {});
    ...
    describe("FIXME", function() {
      ...
      it(
        "Multiple RTC session should not be created in case of voice system failures!"
      );
    });
  });
});
