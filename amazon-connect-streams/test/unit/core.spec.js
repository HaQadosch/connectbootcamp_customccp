...
describe("Core", function() {
  before(function() {
    this.checkNotInitiazed = sinon
      .stub(connect.core, "checkNotInitialized")
      .returns(true);
    this.params = {
      agentLogin: "abc",
      authToken: "xyz",
  ...
  describe("#connect.core.initSharedWorker()", function() {
    ...
    it("shared worker initialization", function() {
      ...
      expect(
        SharedWorker.calledWith(
          this.params.sharedWorkerUrl,
          "ConnectSharedWorker"
        )
      );
    });
  ...
  describe("#connect.core.initRingtoneEngines()", function() {
    ...
    it("Ringtone init with VoiceRingtoneEngine", function() {
      ...
      connect.core
        .getEventBus()
        .trigger(connect.AgentEvents.INIT, new connect.Agent());
      connect.core
        .getEventBus()
        .trigger(connect.AgentEvents.REFRESH, new connect.Agent());
