...
describe("RingtoneEngine", function() {
  ...
  describe("#connect.VoiceRingtoneEngine", function() {
    before(function() {
      ...
      this.ringtoneSetup = sinon.stub(
        this.voiceRingtoneEngine,
        "_ringtoneSetup"
      );
      assert.doesNotThrow(
        this.voiceRingtoneEngine._driveRingtone,
        Error,
        "Not implemented."
      );
  ...
  describe("#connect.QueueCallbackRingtoneEngine", function() {
    before(function() {
      this.queueCallbackRingtoneEngine = new connect.QueueCallbackRingtoneEngine(
        ringtoneObj
      );
      this.ringtoneSetup = sinon.stub(
        this.queueCallbackRingtoneEngine,
        "_ringtoneSetup"
      );
      assert.doesNotThrow(
        this.queueCallbackRingtoneEngine._driveRingtone,
        Error,
        "Not implemented."
      );
      sinon.stub(contact, "getType").returns(lily.ContactType.QUEUE_CALLBACK);
