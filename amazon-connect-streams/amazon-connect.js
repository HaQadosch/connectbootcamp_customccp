...
})(
  {
        ...
        module.exports = {
          ...
          operations: {
            ...
            UpdateContactAttributes: {
              input: {
                type: "structure",
                required: ["authentication", "contactId", "attributes"],
                members: {
                  authentication: {
                    shape: "S2"
                  },
    ...
    5: [
      ...
      },
      {
        ...
        "../lib/node_loader": 8,
        "../lib/service": 41,
        "../lib/services/cognitoidentity": 42
      }
    ],
    6: [
      function(require, module, exports) {
    ...
    8: [
      ...
      },
      {
        ...
        "./http/xhr": 19,
        "./util": 52,
        "./xml/browser_parser": 53,
        _process: 117,
        "buffer/": 58,
        "crypto-browserify": 60,
        "querystring/": 124,
        "url/": 125
      }
    ],
    9: [
      ...
      },
      {
        "./core": 10,
        "./credentials": 11,
        "./credentials/credential_provider_chain": 13
      }
    ],
    10: [
      function(require, module, exports) {
      ...
      },
      {
        "./config": 9,
        "./credentials": 11,
        "./credentials/cognito_identity_credentials": 12,
        "./credentials/credential_provider_chain": 13,
        "./credentials/saml_credentials": 14,
        "./credentials/temporary_credentials": 15,
        "./credentials/web_identity_credentials": 16,
        "./event_listeners": 17,
        "./http": 18,
        "./json/builder": 20,
        "./json/parser": 21,
        ...
        "./model/operation": 24,
        "./model/paginator": 25,
        "./model/resource_waiter": 26,
        "./model/shape": 27,
        "./param_validator": 28,
        "./protocol/json": 29,
        "./protocol/query": 30,
        "./protocol/rest": 31,
        "./protocol/rest_json": 32,
        "./protocol/rest_xml": 33,
        "./request": 37,
        "./resource_waiter": 38,
        "./response": 39,
        "./sequential_executor": 40,
        "./service": 41,
        "./signers/request_signer": 45,
        "./util": 52,
        "./xml/builder": 54
      }
    ],
    11: [
      function(require, module, exports) {
        ...
        AWS.Credentials.addPromisesToClass = function addPromisesToClass(
          PromiseDependency
        ) {
          this.prototype.getPromise = AWS.util.promisifyMethod(
            "get",
            PromiseDependency
          );
          this.prototype.refreshPromise = AWS.util.promisifyMethod(
            "refresh",
            PromiseDependency
          );
        };
      ...
      function(require, module, exports) {
        ...
        AWS.CognitoIdentityCredentials = AWS.util.inherit(AWS.Credentials, {
          ...
          clearCachedId: function clearCache() {
            ...
            delete this.storage[
              this.localStorageKey.providers + poolId + loginId
            ];
          },
          ...
          createClients: function() {
            ...
            this.cognito =
              this.cognito || new CognitoIdentity({ params: this.params });
    ...
    13: [
      function(require, module, exports) {
        ...
        AWS.CredentialProviderChain = AWS.util.inherit(AWS.Credentials, {
          constructor: function CredentialProviderChain(providers) {
            if (providers) {
              ...
              this.providers = AWS.CredentialProviderChain.defaultProviders.slice(
                0
              );
            }
          },
        ...
        AWS.CredentialProviderChain.addPromisesToClass = function addPromisesToClass(
          PromiseDependency
        ) {
          this.prototype.resolvePromise = AWS.util.promisifyMethod(
            "resolve",
            PromiseDependency
          );
        };
    ...
    17: [
      function(require, module, exports) {
        ...
        AWS.EventListeners = {
          Core: new SequentialExecutor().addNamedListeners(function(
            add,
            addAsync
          ) {
            addAsync(
            ...
            add("VALIDATE_PARAMETERS", "validate", function VALIDATE_PARAMETERS(
              req
            ) {
            ...
            addAsync("COMPUTE_SHA256", "afterBuild", function COMPUTE_SHA256(
              req,
              done
            ) {
            ...
            add("SET_CONTENT_LENGTH", "afterBuild", function SET_CONTENT_LENGTH(
              req
            ) {
            ...
            addAsync("SEND", "send", function SEND(resp, done) {
              ...
              function progress(httpResp) {
                ...
                httpResp.on("receiveProgress", function onReceiveProgress(
                  value
                ) {
            ...
            add("HTTP_HEADERS", "httpHeaders", function HTTP_HEADERS(
              statusCode,
              headers,
              resp
            ) {
              ...
              if (dateHeader) {
                ...
                if (
                  resp.request.service.config.correctClockSkew &&
            ...
            add("HTTP_DONE", "httpDone", function HTTP_DONE(resp) {
              if (
                resp.httpResponse.buffers &&
                resp.httpResponse.buffers.length > 0
              ) {
            ...
            add("FINALIZE_ERROR", "retry", function FINALIZE_ERROR(resp) {
              if (resp.httpResponse.statusCode) {
                ...
                if (resp.error.retryable === undefined) {
                  resp.error.retryable = this.service.retryableError(
                    resp.error,
                    this
                  );
                }
            ...
            add("EXPIRED_SIGNATURE", "retry", function EXPIRED_SIGNATURE(resp) {
              ...
              if (
                ...
                if (
                  err.code.match(/Signature/) &&
                  err.message.match(/expired/)
                ) {
                  resp.error.retryable = true;
                }
              }
            ...
            add("CLOCK_SKEWED", "retry", function CLOCK_SKEWED(resp) {
              if (!resp.error) return;
              if (
                this.service.clockSkewError(resp.error) &&
            ...
            add("REDIRECT", "retry", function REDIRECT(resp) {
              if (
                ...
                this.httpRequest.endpoint = new AWS.Endpoint(
                  resp.httpResponse.headers["location"]
                );
                this.httpRequest.headers[
                  "Host"
                ] = this.httpRequest.endpoint.host;
            ...
            add("RETRY_CHECK", "retry", function RETRY_CHECK(resp) {
              if (resp.error) {
                if (
                  resp.error.redirect &&
                  resp.redirectCount < resp.maxRedirects
                ) {
                  resp.error.retryDelay = 0;
                } else if (resp.retryCount < resp.maxRetries) {
                  resp.error.retryDelay =
                    this.service.retryDelays(resp.retryCount) || 0;
                }
              }
            });
            ...
            addAsync(
              "RESET_RETRY_STATE",
              "afterRetry",
              function RESET_RETRY_STATE(resp, done) {
                var delay,
                  willRetry = false;
          ...
          Logger: new SequentialExecutor().addNamedListeners(function(add) {
            add("LOG_REQUEST", "complete", function LOG_REQUEST(resp) {
              ...
              function buildMessage() {
                ...
                message +=
                  "[AWS " + req.service.serviceIdentifier + " " + status;
                message +=
                  " " + delta.toString() + "s " + resp.retryCount + " retries]";
      ...
      function(require, module, exports) {
        ...
        AWS.HttpRequest = inherit({
          ...
          setUserAgent: function setUserAgent(customUserAgent) {
            ...
            this.headers[prefix + "User-Agent"] =
              AWS.util.userAgent() + customSuffix;
          },
        ...
        AWS.XHRClient = AWS.util.inherit({
          handleRequest: function handleRequest(
            ...
            xhr.addEventListener(
              ...
              function() {
                ...
                if (
                  ...
                  emitter.headers = self.parseHeaders(
            ...
            xhr.addEventListener(
              ...
              function() {
                errCallback(
                  AWS.util.error(new Error("Timeout"), { code: "TimeoutError" })
                );
              },
              false
            );
            ...
            xhr.addEventListener(
              ...
              function() {
                errCallback(
                  AWS.util.error(new Error("Connection aborted"), {
                    code: "RequestAborted"
                  })
                );
              },
            ...
            try {
              ...
              if (
                httpRequest.body &&
                typeof httpRequest.body.buffer === "object"
              ) {
        ...
        function ResourceWaiter(name, waiter, options) {
          ...
          if (waiter.operation) {
            property(
              this,
              "operation",
              util.string.lowerFirst(waiter.operation)
            );
          }
        ...
        function TimestampShape(shape) {
          ...
          this.toType = function(value) {
            ...
            return typeof value === "string" || typeof value === "number"
              ? util.date.parseTimestamp(value)
              : null;
          };
      ...
      function(require, module, exports) {
        ...
        AWS.ParamValidator = AWS.util.inherit({
          ...
          fail: function fail(code, message) {
            this.errors.push(
              AWS.util.error(new Error(message), { code: code })
            );
          },
    ...
    29: [
      function(require, module, exports) {
        ...
        function buildRequest(req) {
          ...
          var target =
            api.targetPrefix + "." + api.operations[req.operation].name;
        ...
        function extractError(resp) {
          ...
          error.code =
            httpResponse.headers["x-amzn-errortype"] || "UnknownError";
        ...
        function extractData(resp) {
          ...
          if (resp.request.service.config.convertResponseTypes === false) {
            ...
            var operation =
              resp.request.service.api.operations[resp.request.operation];
      ...
      { "../json/builder": 20, "../json/parser": 21, "../util": 52 }
    ],
    30: [
      function(require, module, exports) {
        var AWS = require("../core");
      ...
      },
      {
        "../core": 10,
        "../model/shape": 27,
        "../query/query_param_serializer": 34,
        "../util": 52
      }
    ],
    31: [
    ...
    33: [
      function(require, module, exports) {
        ...
        function extractError(resp) {
          ...
          var data = new AWS.XML.Parser().parse(
    ...
    37: [
            ...
            createReadStream: function createReadStream() {
              ...
              this.on("httpHeaders", function streamHeaders(
                ...
                if (statusCode < 300) {
                  req.removeListener(
                    "httpData",
                    AWS.EventListeners.Core.HTTP_DATA
                  );
                  req.removeListener(
                    "httpError",
      ...
      { "./core": 10, "./state_machine": 51, _process: 117, jmespath: 68 }
    ],
    38: [
      function(require, module, exports) {
        var AWS = require("./core");
        ...
        function CHECK_ACCEPTORS(resp) {
          ...
          acceptors.forEach(function(acceptor) {
            if (!acceptorMatched) {
              ...
              if (
                matcher &&
                matcher(resp, acceptor.expected, acceptor.argument)
              ) {
        ...
        AWS.ResourceWaiter = inherit({
          ...
          listeners: new AWS.SequentialExecutor().addNamedListeners(function(
            add
          ) {
          ...
          wait: function wait(params, callback) {
            ...
            var request = this.service.makeRequest(
      ...
      function(require, module, exports) {
        ...
        AWS.Response = inherit({
          ...
          cacheNextPageTokens: function cacheNextPageTokens() {
            ...
            var config = this.request.service.paginationConfig(
              this.request.operation
            );
    ...
    40: [
      function(require, module, exports) {
        ...
        AWS.SequentialExecutor = AWS.util.inherit({
          ...
          listeners: function listeners(eventName) {
            return this._events[eventName]
              ? this._events[eventName].slice(0)
              : [];
          },
          ...
          addNamedListener: function addNamedListener(
            name,
            eventName,
            callback
          ) {
          ...
          addNamedAsyncListener: function addNamedAsyncListener(
            name,
            eventName,
            callback
          ) {
        ...
        AWS.SequentialExecutor.prototype.addListener =
          AWS.SequentialExecutor.prototype.on;
    ...
    41: [
      ...
      { "./core": 10, "./model/api": 22, "./region_config": 36 }
    ],
    42: [
      function(require, module, exports) {
        var AWS = require("../core");
        ...
        function signedUrlBuilder(request) {
          ...
          if (signerClass === AWS.Signers.V4) {
            if (expires > 604800) {
              ...
              var message =
                "Presigning does not support expiry time greater " +
            ...
            request.httpRequest.headers[expiresHeader] = parseInt(
              AWS.util.date.unixTimestamp() + expires,
              10
            ).toString();
          } else {
            throw AWS.util.error(new Error(), {
            ...
            if (callback) {
              request.build(function() {
                if (this.response.error) callback(this.response.error);
                  ...
                  callback(
                    null,
                    AWS.util.urlFormat(request.httpRequest.endpoint)
                  );
                }
              });
            } else {
        ...
        AWS.Signers.S3 = inherit(AWS.Signers.RequestSigner, {
          ...
          canonicalizedAmzHeaders: function canonicalizedAmzHeaders() {
            ...
            AWS.util.arrayEach.call(this, amzHeaders, function(name) {
              parts.push(
                name.toLowerCase() + ":" + String(this.request.headers[name])
              );
            });
          ...
          canonicalizedResource: function canonicalizedResource() {
            ...
            if (querystring) {
              ...
              AWS.util.arrayEach.call(this, querystring.split("&"), function(
                param
              ) {
    ...
    50: [
      function(require, module, exports) {
        ...
        AWS.Signers.V4 = inherit(AWS.Signers.RequestSigner, {
          ...
          updateForPresigned: function updateForPresigned(
            credentials,
            datetime
          ) {
            ...
            AWS.util.each.call(this, this.request.headers, function(
              key,
              value
            ) {
          ...
          signature: function signature(credentials, datetime) {
            ...
            if (
              ...
              var kRegion = AWS.util.crypto.hmac(
                kDate,
                this.request.region,
                "buffer"
              );
              var kService = AWS.util.crypto.hmac(
                kRegion,
                this.serviceName,
                "buffer"
              );
              var kCredentials = AWS.util.crypto.hmac(
                kService,
                "aws4_request",
                "buffer"
              );
          ...
          canonicalHeaders: function canonicalHeaders() {
            ...
            AWS.util.arrayEach.call(this, headers, function(item) {
              ...
              if (this.isSignableHeader(key)) {
                parts.push(
                  key + ":" + this.canonicalHeaderValues(item[1].toString())
                );
              }
            });
            return parts.join("\n");
    ...
    52: [
          ...
          var util = {
            ...
            crypto: {
              ...
              toHex: function toHex(data) {
                ...
                for (var i = 0; i < data.length; i++) {
                  out.push(
                    ("0" + data.charCodeAt(i).toString(16)).substr(-2, 2)
                  );
                }
                return out.join("");
              },
            ...
            isDualstackAvailable: function isDualstackAvailable(service) {
              ...
              if (
                ...
                !metadata.hasOwnProperty(service)
              )
                return false;
      ...
      { "../apis/metadata.json": 3, "./core": 10, _process: 117, fs: 56 }
    ],
    53: [
      function(require, module, exports) {
        var util = require("../util");
        ...
        DomXmlParser.prototype.parse = function(xml, shape) {
          ...
          try {
            if (window.DOMParser) {
              ...
              if (
                isError &&
                (isError.parentNode === result ||
                  isError.parentNode.nodeName === "body" ||
                  isError.parentNode.parentNode === result ||
                  isError.parentNode.parentNode.nodeName === "body")
              ) {
                var errorElement =
                  isError.getElementsByTagName("div")[0] || isError;
                throw util.error(
                  new Error(
                    errorElement.textContent || "Parser error in document"
                  ),
                  {
                    code: "XMLParserError",
                    retryable: true
        ...
        function parseStructure(xml, shape) {
          ...
          util.each(shape.members, function(memberName, memberShape) {
            if (memberShape.isXmlAttribute) {
              ...
              var xmlChild = memberShape.flattened
                ? xml
        ...
        function parseList(xml, shape) {
          var data = [];
          var tagName = shape.flattened
            ? shape.name
            : shape.member.name || "member";
    ...
    54: [
      function(require, module, exports) {
        ...
        XmlBuilder.prototype.toXML = function(
          ...
          return xml.children.length > 0 || noEmpty
            ? xml.root().toString()
            : "";
        };
    ...
    57: [
      ...
      { "base64-js": 55, ieee754: 66, isarray: 67 }
    ],
    58: [
      function(require, module, exports) {
        arguments[4][57][0].apply(exports, arguments);
      },
      { "base64-js": 55, dup: 57, ieee754: 66, isarray: 67 }
    ],
    59: [
      function(require, module, exports) {
    ...
    60: [
      ...
      { "./md5": 61, "./rng": 62, "./sha": 63, "./sha256": 64, buffer: 57 }
    ],
    61: [
      function(require, module, exports) {
    ...
    69: [
      ...
      {
        "../internal/arrayEvery": 70,
        "../internal/baseCallback": 72,
        "../internal/baseEvery": 76,
        "../lang/isArray": 103
      }
    ],
    70: [
    ...
    72: [
      ...
      {
        "../utility/identity": 116,
        "./baseMatches": 83,
        "./baseMatchesProperty": 84,
        "./baseProperty": 85,
        "./bindCallback": 88,
        "./isBindable": 93
      }
    ...
    75: [
      ...
      { "./baseForOwn": 78, "./isLength": 96, "./toObject": 101 }
    ],
    76: [
      function(require, module, exports) {
    ...
    83: [
      ...
      { "../object/keys": 112, "./baseIsMatch": 82, "./isStrictComparable": 98 }
    ],
    84: [
      function(require, module, exports) {
        var baseIsEqual = require("./baseIsEqual"),
        ...
        function baseMatchesProperty(key, value) {
          ...
          return function(object) {
            return (
              object != null && baseIsEqual(value, object[key], null, true)
            );
          };
        }
      ...
      { "./baseIsEqual": 79, "./isStrictComparable": 98 }
    ],
    85: [
      function(require, module, exports) {
    ...
    86: [
      ...
      { "../utility/identity": 116, "./metaMap": 99 }
    ],
    87: [
      function(require, module, exports) {
    ...
    89: [
        ...
        function createAssigner(assigner) {
          return function() {
            ...
            if (length > 3 && typeof customizer == "function") {
              ...
              customizer =
                length > 2 && typeof thisArg == "function" ? thisArg : null;
      ...
      { "./bindCallback": 88, "./isIterateeCall": 95 }
    ],
    90: [
      function(require, module, exports) {
    ...
    93: [
      ...
      { "../lang/isNative": 106, "../support": 115, "./baseSetData": 86 }
    ],
    94: [
      function(require, module, exports) {
    ...
    95: [
      ...
      { "../lang/isObject": 107, "./isIndex": 94, "./isLength": 96 }
    ],
    96: [
      function(require, module, exports) {
        var MAX_SAFE_INTEGER = Math.pow(2, 53) - 1;
    ...
    102: [
      ...
      { "../internal/isLength": 96, "../internal/isObjectLike": 97 }
    ],
    103: [
      function(require, module, exports) {
        var isLength = require("../internal/isLength"),
      ...
      {
        "../internal/isLength": 96,
        "../internal/isObjectLike": 97,
        "./isNative": 106
      }
    ],
    104: [
    ...
    105: [
      function(require, module, exports) {
        (function(global) {
          ...
          var Uint8Array =
            isNative((Uint8Array = global.Uint8Array)) && Uint8Array;
      ...
      { "../internal/baseIsFunction": 81, "./isNative": 106 }
    ],
    106: [
      function(require, module, exports) {
      ...
      { "../internal/isObjectLike": 97, "../string/escapeRegExp": 114 }
    ],
    107: [
      function(require, module, exports) {
    ...
    110: [
      ...
      { "../internal/baseAssign": 71, "../internal/createAssigner": 89 }
    ],
    111: [
      function(require, module, exports) {
      ...
      {
        "../internal/baseCopy": 73,
        "../internal/baseCreate": 74,
        "../internal/isIterateeCall": 95,
        "./keys": 112
      }
    ],
    112: [
    ...
    128: [
      ...
      { "./support/isBuffer": 127, _process: 117, inherits: 126 }
    ],
    129: [
      function(require, module, exports) {
        (function() {
        ...
        (function() {
          ...
          module.exports = XMLBuilder = (function() {
            ...
            XMLBuilder.prototype.toString = function(options) {
              ...
              indent =
                (ref = options != null ? options.indent : void 0) != null
                  ? ref
                  : "  ";
              offset =
                (ref1 = options != null ? options.offset : void 0) != null
                  ? ref1
                  : 0;
              newline =
                (ref2 = options != null ? options.newline : void 0) != null
                  ? ref2
                  : "\n";
              r = "";
              if (this.xmldec != null) {
    ...
    131: [
      ...
      { "./XMLNode": 140, "lodash/object/create": 111 }
    ],
    132: [
      function(require, module, exports) {
        (function() {
    ...
    134: [
      ...
      { "lodash/lang/isArray": 103, "lodash/object/create": 111 }
    ],
    135: [
      function(require, module, exports) {
        (function() {
      ...
      { "lodash/lang/isObject": 107, "lodash/object/create": 111 }
    ],
    136: [
      function(require, module, exports) {
        (function() {
    ...
    139: [
          ...
          module.exports = XMLElement = (function(superClass) {
            ...
            XMLElement.prototype.toString = function(options, level) {
              ...
              if (
                ...
                every(this.children, function(e) {
                  return e.value === "";
                })
              ) {
                r += "/>";
      ...
      },
      {
        ...
        "./XMLNode": 140,
        "./XMLProcessingInstruction": 141,
        "lodash/collection/every": 69,
        "lodash/lang/isArray": 103,
        "lodash/lang/isFunction": 105,
        "lodash/lang/isObject": 107,
        "lodash/object/create": 111
      }
    ],
              ...
              if (isArray(name)) {
                ...
                for (key in name) {
                  ...
                  if (
                    ...
                    key.indexOf(this.stringify.convertPIKey) === 0
                  ) {
                    lastChild = this.instruction(
                      key.substr(this.stringify.convertPIKey.length),
                      val
                    );
                  } else if (isObject(val)) {
                    if (
                      !this.options.ignoreDecorators &&
                      this.stringify.convertListKey &&
                      key.indexOf(this.stringify.convertListKey) === 0 &&
                      isArray(val)
                    ) {
          ...
          module.exports = XMLStringifier = (function() {
            function XMLStringifier(options) {
              ...
              this.allowSurrogateChars =
                options != null ? options.allowSurrogateChars : void 0;
    ...
    145: [
      ...
      { "./XMLBuilder": 130, "lodash/object/assign": 110 }
    ],
    146: [
      function(require, module, exports) {
        ...
        AWS.apiLoader.services["connect"][
          "2017-02-15"
        ] = require("../apis/connect-2017-02-15.min");
        ...
        AWS.apiLoader.services["sts"][
          "2011-06-15"
        ] = require("../apis/sts-2011-06-15.min");
      },
      {
        "../apis/connect-2017-02-15.min": 2,
...
(function() {
  ...
  var isValidLogComponent = function(component) {
    if (
      ...
      component === LogComponent.SOFTPHONE
    ) {
      return true;
    } else {
      return false;
  ...
  var extractLoggerArgs = function(loggerArgs) {
    ...
    return { format: format, component: component, args: args };
  };
  ...
  LogEntry.prototype.toString = function() {
    return connect.sprintf(
      "[%s] [%s]: %s",
      this.getTime() && this.getTime().toISOString
        ? this.getTime().toISOString()
        : "???",
      this.getLevel(),
      this.getText()
    );
  ...
  Logger.prototype.setLogRollInterval = function(interval) {
    ...
    if (!this._logRollTimer || interval !== this._logRollInterval) {
      ...
      this.warn(
        "Logger is already set to the given interval: %d",
        this._logRollInterval
      );
    }
  };
  ...
  Logger.prototype.addLogEntry = function(logEntry) {
    ...
    if (
      logEntry.level in LogLevelOrder &&
  ...
  Logger.prototype.trace = function() {
    ...
    return this.write(
      logArgs.component,
      LogLevel.TRACE,
      connect.vsprintf(logArgs.format, logArgs.args)
    );
  };
  ...
  Logger.prototype.download = function() {
    var logBlob = new global.Blob(
      [JSON.stringify(this._rolledLogs.concat(this._logs), undefined, 4)],
      ["text/plain"]
    );
  ...
  Logger.prototype.scheduleUpstreamLogPush = function(conduit) {
    if (!connect.upstreamLogPushScheduled) {
      ...
      global.setInterval(
        connect.hitch(this, this.reportMasterLogsUpStream, conduit),
        LOG_REPORT_INTERVAL_MILLIS
      );
    }
  };
  ...
  var DownstreamConduitLogger = function(conduit) {
    ...
    global.setInterval(
      connect.hitch(this, this._pushLogsDownstream),
...
(function() {
  ...
  connect.containsValue = function(obj, value) {
    if (obj instanceof Array) {
      ...
      return (
        connect.find(connect.values(obj), function(v) {
          return v === value;
        }) != null
      );
    }
  ...
  connect.getOperaBrowserVersion = function() {
    ...
    var operaVersion =
      userAgent.indexOf("Version") !== -1
        ? userAgent.substring(versionOffset + 8)
        : userAgent.substring(versionOffset + 6);
    if (operaVersion) {
  ...
  connect.NotificationManager.prototype.requestPermission = function() {
    ...
    if (!("Notification" in global)) {
      ...
      global.Notification.permission === NotificationPermission.DENIED
    ) {
      connect
        .getLog()
        .warn("The user has requested to not receive notifications.");
      this.permission = NotificationPermission.DENIED;
  ...
  connect.NotificationManager.prototype.show = function(title, options) {
    if (this.permission === NotificationPermission.GRANTED) {
      ...
      connect
        .getLog()
        .warn("Unable to show notification.")
        .withObject({
          title: title,
          options: options
        });
      ...
      connect
        .getLog()
        .warn("Deferring notification until user decides to allow or deny.")
        .withObject(params);
  ...
  connect.NotImplementedError.prototype = Object.create(
    connect.BaseError.prototype
  );
  connect.NotImplementedError.prototype.constructor =
    connect.NotImplementedError;
...
(function() {
  ...
  var StreamMultiplexer = function(streams) {
    ...
    this.streamMap = streams
      ? connect.index(streams, function(s) {
          return s.getId();
        })
      : {};
  ...
  var Conduit = function(name, upstream, downstream) {
    ...
    this.upstream.onMessage(
      connect.hitch(this, this._dispatchEvent, this.upstreamBus)
    );
    this.downstream.onMessage(
      connect.hitch(this, this._dispatchEvent, this.downstreamBus)
    );
  };
  ...
  var IFrameConduit = function(name, window, iframe, domain) {
    Conduit.call(
      this,
      name,
      new WindowIOStream(window, iframe.contentWindow, domain || "*"),
      null
    );
  };
...
(function() {
  ...
  NullClient.prototype._callImpl = function(method, params, callbacks) {
    if (callbacks && callbacks.failure) {
      var message = connect.sprintf(
        "No such method exists on NULL client: %s",
        method
      );
   ...
   */
  var UpstreamConduitClientBase = function(
    conduit,
    requestEvent,
    responseEvent
  ) {
    ...
    this.conduit.onUpstream(
      responseEvent,
      connect.hitch(this, this._handleResponse)
    );
  };
  ...
  UpstreamConduitClientBase.prototype._callImpl = function(
    method,
    params,
    callbacks
  ) {
    var request = connect.EventFactory.createRequest(
      this.requestEvent,
      method,
      params
    );
  ...
  UpstreamConduitClientBase.prototype._getCallbacksForRequest = function(
    requestId
  ) {
  ...
  var UpstreamConduitClient = function(conduit) {
    UpstreamConduitClientBase.call(
      this,
      conduit,
      connect.EventType.API_REQUEST,
      connect.EventType.API_RESPONSE
    );
  };
  UpstreamConduitClient.prototype = Object.create(
    UpstreamConduitClientBase.prototype
  );
  ...
  var UpstreamConduitMasterClient = function(conduit) {
    UpstreamConduitClientBase.call(
      this,
      conduit,
      connect.EventType.MASTER_REQUEST,
      connect.EventType.MASTER_RESPONSE
    );
  };
  UpstreamConduitMasterClient.prototype = Object.create(
    UpstreamConduitClientBase.prototype
  );
  ...
  AWSClient.prototype._callImpl = function(method, params, callbacks) {
    ...
    if (!connect.contains(this.client, method)) {
      var message = connect.sprintf(
        "No such method exists on AWS client: %s",
        method
      );
      callbacks.failure(new connect.ValueError(message), { message: message });
    } else {
        ...
        .send(function(err, data) {
          try {
            if (err) {
              ...
              log.trace(
                "AWSClient: <-- Operation '%s' failed: %s",
                method,
                JSON.stringify(err)
              );
            } else {
              log
                .trace("AWSClient: <-- Operation '%s' succeeded.", method)
                .withObject(data);
              callbacks.success(data);
            }
          } catch (e) {
            connect
              .getLog()
              .error("Failed to handle AWS API request for method %s", method)
              .withException(e);
          }
        });
    }
  ...
  AWSClient.prototype._translateParams = function(method, params) {
    switch (method) {
      case connect.ClientMethods.UPDATE_AGENT_CONFIGURATION:
        params.configuration = this._translateAgentConfiguration(
...
(function() {
    ...
    if (fromStateObj instanceof Array) {
      ...
      if (typeof assocObj === "function") {
        this._addAssociation(
          new FunctionalGraphLink(fromStateObj, toStateObj, assocObj)
        );
      } else if (assocObj instanceof Array) {
        this._addAssociation(
          new DirectGraphLink(fromStateObj, toStateObj, assocObj)
        );
      } else {
        this._addAssociation(
          new DirectGraphLink(fromStateObj, toStateObj, [assocObj])
  ...
  EventGraph.prototype.getAssociations = function(context, fromState, toState) {
    ...
    associations = associations.concat(
      this._getAssociationsFromMap(toMapFromAny, context, fromState, toState)
    );
    associations = associations.concat(
      this._getAssociationsFromMap(toMap, context, fromState, toState)
    );
  ...
  EventGraph.prototype._getAssociationsFromMap = function(
    map,
    context,
    fromState,
    toState
...
(function() {
   ...
   * enum ContactType
   */
  connect.ContactType = connect.makeEnum(["voice", "queue_callback"]);
  ...
  Agent.prototype.getStateDuration = function() {
    return (
      connect.now() -
      this._getData().snapshot.state.startTimestamp.getTime() +
      connect.core.getSkew()
    );
  };
  ...
  Agent.prototype.getContacts = function(contactTypeFilter) {
    ...
    return this._getData()
      .snapshot.contacts.map(function(contactData) {
  ...
  Agent.prototype.setConfiguration = function(configuration, callbacks) {
    ...
    client.call(
      connect.ClientMethods.UPDATE_AGENT_CONFIGURATION,
      {
  ...
  Agent.prototype.setState = function(state, callbacks) {
    var client = connect.core.getClient();
    client.call(
      connect.ClientMethods.PUT_AGENT_STATE,
      {
    ...
    client.call(
      connect.ClientMethods.CREATE_OUTBOUND_CONTACT,
      {
        ...
        queueARN:
          params.queueARN ||
          params.queueId ||
          this.getRoutingProfile().defaultOutboundQueue.queueARN
      },
      {
  ...
  Agent.prototype.getEndpoints = function(queueARNs, callbacks, pageInfoIn) {
    ...
    client.call(
      connect.ClientMethods.GET_ENDPOINTS,
      {
        queueARNs: queueARNs,
  ...
  Contact.prototype._getData = function() {
    return connect.core
      ...
      .getContactData(this.getContactId());
  };
  ...
  Contact.prototype.getStatusDuration = function() {
    return (
      connect.now() -
      this._getData().state.timestamp.getTime() +
      connect.core.getSkew()
    );
  };
  ...
  Contact.prototype.getInitialConnection = function() {
    return (
      connect.find(this.getConnections(), function(conn) {
  ...
  Contact.prototype.getThirdPartyConnections = function() {
    return this.getConnections().filter(function(conn) {
      return (
        !conn.isInitialConnection() &&
        conn.getType() !== connect.ConnectionType.AGENT
      );
    });
  };
  ...
  Contact.prototype.getSingleActiveThirdPartyConnection = function() {
    return (
      this.getThirdPartyConnections().filter(function(conn) {
  ...
  Contact.prototype.getAgentConnection = function() {
    return connect.find(this.getConnections(), function(conn) {
      ...
      return (
        connType === connect.ConnectionType.AGENT ||
        connType === connect.ConnectionType.MONITORING
      );
    });
  };
  ...
  Contact.prototype.accept = function(callbacks) {
    ...
    var self = this;
    client.call(
      connect.ClientMethods.ACCEPT_CONTACT,
      {
  ...
  Contact.prototype.destroy = function(callbacks) {
    var client = connect.core.getClient();
    client.call(
      connect.ClientMethods.DESTROY_CONTACT,
      {
        contactId: this.getContactId()
      },
      callbacks
  ...
  Contact.prototype.notifyIssue = function(issueCode, description, callbacks) {
    var client = connect.core.getClient();
    client.call(
      connect.ClientMethods.NOTIFY_CONTACT_ISSUE,
      {
        contactId: this.getContactId(),
        issueCode: issueCode,
  ...
  Contact.prototype.addConnection = function(endpointIn, callbacks) {
    ...
    client.call(
      connect.ClientMethods.CREATE_ADDITIONAL_CONNECTION,
      {
        contactId: this.getContactId(),
        endpoint: endpoint
      },
  ...
  Contact.prototype.toggleActiveConnections = function(callbacks) {
    ...
    client.call(
      connect.ClientMethods.TOGGLE_ACTIVE_CONNECTIONS,
      {
        contactId: this.getContactId(),
  ...
  Contact.prototype.sendSoftphoneMetrics = function(
    softphoneStreamStatistics,
    callbacks
  ) {
    var client = connect.core.getClient();
  ...
  Contact.prototype.conferenceConnections = function(callbacks) {
    var client = connect.core.getClient();
    client.call(
      connect.ClientMethods.CONFERENCE_CONNECTIONS,
      {
        contactId: this.getContactId()
      },
      callbacks
  ...
  Connection.prototype._getData = function() {
    return connect.core
      .getAgentDataProvider()
      .getConnectionData(this.getContactId(), this.getConnectionId());
  };
  ...
  Connection.prototype.isActive = function() {
    return connect.contains(
      connect.CONNECTION_ACTIVE_STATES,
      this.getStatus().type
    );
  };
  ...
  var ConnectionSnapshot = function(connectionData) {
    connect.Connection.call(
      this,
      connectionData.contactId,
  ...
  Endpoint.prototype.stripPhoneNumber = function() {
    return this.phoneNumber
      ? this.phoneNumber.replace(/sip:([^@]*)@.*/, "$1")
      : "";
  };
  ...
  connect.ifMaster = function(topic, f_true, f_else) {
    ...
    if (!connect.core.masterClient) {
      ...
      connect
        .getLog()
        .warn(
          "We can't be the master for topic '%s' because there is no master client!",
          topic
        );
      if (f_else) {
        f_else();
    ...
    masterClient.call(
      connect.MasterMethods.CHECK_MASTER,
      {
        topic: topic
      },
      {
...
(function() {
  ...
  var LOGIN_URL_PATTERN =
    "https://{alias}.awsapps.com/auth/?client_id={client_id}&redirect_uri={redirect}";
  var CLIENT_ID_MAP = {
  ...
  connect.core.checkNotInitialized = function() {
    if (connect.core.initialized) {
      var log = connect.getLog();
      log.warn(
        "Connect core already initialized, only needs to be initialized once."
      );
    }
  };
  ...
  connect.core.init = function(params) {
    ...
    connect.core.agentDataProvider = new AgentDataProvider(
  ...
  connect.core.initRingtoneEngines = function(params) {
    ...
    var setupRingtoneEngines = function(ringtoneSettings) {
      ...
      connect.assertTrue(
        ringtoneSettings.voice.ringtoneUrl || ringtoneSettings.voice.disabled,
        "ringtoneSettings.voice.ringtoneUrl must be provided or ringtoneSettings.voice.disabled must be true"
      );
      connect.assertNotNull(
        ringtoneSettings.queue_callback,
        "ringtoneSettings.queue_callback"
      );
      connect.assertTrue(
        ringtoneSettings.queue_callback.ringtoneUrl ||
          ringtoneSettings.queue_callback.disabled,
        "ringtoneSettings.voice.ringtoneUrl must be provided or ringtoneSettings.queue_callback.disabled must be true"
      );
      ...
      connect.agent(function(agent) {
        agent.onRefresh(function() {
          connect.ifMaster(connect.MasterTopics.RINGTONE, function() {
            if (
              !ringtoneSettings.voice.disabled &&
              !connect.core.ringtoneEngines.voice
            ) {
              connect.core.ringtoneEngines.voice = new connect.VoiceRingtoneEngine(
                ringtoneSettings.voice
              );
            ...
            if (
              ...
              connect.core.ringtoneEngines.queue_callback = new connect.QueueCallbackRingtoneEngine(
                ringtoneSettings.queue_callback
              );
    ...
    var mergeParams = function(params, otherParams) {
      ...
      if (otherParams.softphone) {
        ...
        if (otherParams.softphone.ringtoneUrl) {
          ...
          params.ringtone.queue_callback.ringtoneUrl =
            otherParams.softphone.ringtoneUrl;
        }
      }

      // Merge in ringtone settings from downstream.
      if (otherParams.ringtone) {
        params.ringtone.voice = connect.merge(
          params.ringtone.voice,
          otherParams.ringtone.voice || {}
        );
        params.ringtone.queue_callback = connect.merge(
          params.ringtone.queue_callback,
          otherParams.ringtone.voice || {}
        );
      }
    };
  ...
  connect.core.initSoftphoneManager = function(paramsIn) {
    ...
    var competeForMasterOnAgentUpdate = function(softphoneParamsIn) {
      var softphoneParams = connect.merge(
        params.softphone || {},
        softphoneParamsIn
      );
  ...
  connect.core.initSharedWorker = function(params) {
    ...
    var sharedWorkerUrl = connect.assertNotNull(
      params.sharedWorkerUrl,
      "params.sharedWorkerUrl"
    );
    var authToken = connect.assertNotNull(params.authToken, "params.authToken");
    var refreshToken = connect.assertNotNull(
      params.refreshToken,
      "params.refreshToken"
    );
    var authTokenExpiration = connect.assertNotNull(
      params.authTokenExpiration,
      "params.authTokenExpiration"
    );
    var region = connect.assertNotNull(params.region, "params.region");
    var endpoint = params.endpoint || null;
    ...
    try {
      ...
      var conduit = new connect.Conduit(
      ...
      connect.core.masterClient = new connect.UpstreamConduitMasterClient(
        conduit
      );
      ...
      connect.core
        .getEventBus()
        .subscribe(connect.EventType.TERMINATE, conduit.passUpstream());

      // Refresh the page when we receive the TERMINATED response from the
      // shared worker.
      connect.core
        .getEventBus()
        .subscribe(connect.EventType.TERMINATED, function() {
      ...
      connect
        .getLog()
        .error("Failed to initialize the API shared worker, we're dead!")
        .withException(e);
    }
  };
  ...
  connect.core.initCCP = function(containerDiv, paramsIn) {
    ...
    connect.core.keepaliveManager = new KeepaliveManager(
      conduit,
      connect.core.getEventBus(),
      ...
      .subscribe(connect.EventType.ACK_TIMEOUT, function() {
        ...
        if (connect.core.iframeRefreshInterval == null) {
          ...
          conduit.onUpstream(connect.EventType.ACKNOWLEDGE, function() {
            ...
            connect.core
              .getPopupManager()
              .clear(connect.MasterTopics.LOGIN_POPUP);
          });
        }
      });
  };
  ...
  KeepaliveManager.prototype.start = function() {
    ...
    this.ackSub = this.conduit.onUpstream(
  ...
  KeepaliveManager.prototype.deferStart = function() {
    if (this.synTimer == null) {
      this.synTimer = global.setTimeout(
        connect.hitch(this, this.start),
        this.synTimeout
      );
    }
  };
  ...
  var AgentDataProvider = function(bus) {
    ...
    this.bus.subscribe(
      ...
      connect.hitch(this, this.updateAgentData)
    );
  };
  ...
  AgentDataProvider.prototype.getContactData = function(contactId) {
    ...
    var contactData = connect.find(agentData.snapshot.contacts, function(
      ctdata
    ) {
  ...
  AgentDataProvider.prototype.getConnectionData = function(
    contactId,
    connectionId
  ) {
    ...
    if (connectionData == null) {
      throw new connect.StateError(
        "Connection %s for contact %s no longer exists.",
        connectionId,
        contactId
      );
    }
  ...
  AgentDataProvider.prototype._diffContacts = function(oldAgentData) {
    var diff = {
      ...
      removed: {},
      common: {},
      oldMap: connect.index(
        oldAgentData == null ? [] : oldAgentData.snapshot.contacts,
        function(contact) {
          return contact.contactId;
        }
      ),
      newMap: connect.index(this.agentData.snapshot.contacts, function(
        contact
      ) {
        return contact.contactId;
      })
  ...
  AgentDataProvider.prototype._fireAgentUpdateEvents = function(oldAgentData) {
    ...
    var oldAgentState =
      oldAgentData == null
        ? connect.AgentAvailStates.INIT
        : oldAgentData.snapshot.state.name;
    var newAgentState = this.agentData.snapshot.state.name;
    var oldRoutingState =
      oldAgentData == null
        ? connect.AgentStateType.INIT
        : oldAgentData.snapshot.state.type;
    var newRoutingState = this.agentData.snapshot.state.type;

    if (oldRoutingState !== newRoutingState) {
      connect.core
        .getAgentRoutingEventGraph()
        .getAssociations(this, oldRoutingState, newRoutingState)
    ...
    if (oldAgentState !== newAgentState) {
      ...
      connect.core
        .getAgentStateEventGraph()
        .getAssociations(this, oldAgentState, newAgentState)
        .forEach(function(event) {
          self.bus.trigger(event, new connect.Agent());
        });
    }
    ...
    if (oldAgentData !== null) {
      ...
      diff = {
        added: connect.index(this.agentData.snapshot.contacts, function(
          contact
        ) {
          return contact.contactId;
        }),
    ...
    connect.values(diff.added).forEach(function(contactData) {
      self.bus.trigger(
        ...
        new connect.Contact(contactData.contactId)
      );
      self._fireContactUpdateEvents(
        contactData.contactId,
        connect.ContactStateType.INIT,
        contactData.state.type
      );
    });
    ...
    connect.values(diff.removed).forEach(function(contactData) {
      self.bus.trigger(
        ...
        new connect.ContactSnapshot(contactData)
      );
      self.bus.trigger(
        connect.core.getContactEventName(
          connect.ContactEvents.DESTROYED,
          contactData.contactId
        ),
        new connect.ContactSnapshot(contactData)
    ...
    connect.keys(diff.common).forEach(function(contactId) {
      self._fireContactUpdateEvents(
        contactId,
        diff.oldMap[contactId].state.type,
        diff.newMap[contactId].state.type
      );
    });
  };

  AgentDataProvider.prototype._fireContactUpdateEvents = function(
    contactId,
    oldContactState,
    newContactState
  ) {
    ...
    if (oldContactState !== newContactState) {
      connect.core
        .getContactEventGraph()
        .getAssociations(this, oldContactState, newContactState)
        .forEach(function(event) {
          self.bus.trigger(event, new connect.Contact(contactId));
          self.bus.trigger(
            connect.core.getContactEventName(event, contactId),
            new connect.Contact(contactId)
          );
        });
    }

    self.bus.trigger(
      connect.ContactEvents.REFRESH,
      new connect.Contact(contactId)
    );
    self.bus.trigger(
      connect.core.getContactEventName(
  ...
  AgentDataProvider.prototype._unsubAllContactEventsForContact = function(
    contactId
  ) {
    var self = this;
    connect.values(connect.ContactEvents).forEach(function(eventName) {
      self.bus
        .getSubscriptions(
          connect.core.getContactEventName(eventName, contactId)
        )
        .map(function(sub) {
          sub.unsubscribe();
        });
  ...
  connect.core.getContactEventName = function(eventName, contactId) {
    ...
    if (!connect.contains(connect.values(connect.ContactEvents), eventName)) {
      throw new connect.ValueError(
        "%s is not a valid contact event.",
        eventName
      );
    }
  ...
  connect.core.getLocalTimestamp = function() {
    return connect.core.getAgentDataProvider().getAgentData().snapshot
      .localTimestamp;
  };
  ...
  connect.core.contactEventGraph = new connect.EventGraph()
    ...
    .assoc(
      connect.values(connect.CONTACT_ACTIVE_STATES),
      connect.values(
        connect.relativeComplement(
          connect.CONTACT_ACTIVE_STATES,
          connect.ContactStateType
        )
      ),
  ...
  connect.core.getClient = function() {
    if (!connect.core.client) {
      throw new connect.StateError(
        "The connect core has not been initialized!"
      );
    }
...
(function() {
  ...
  RingtoneEngineBase.prototype._publishTelemetryEvent = function(
    eventName,
    contact
  ) {
  ...
  VoiceRingtoneEngine.prototype._driveRingtone = function() {
    ...
    var onContactConnect = function(contact) {
      if (
        contact.getType() === lily.ContactType.VOICE &&
  ...
  QueueCallbackRingtoneEngine.prototype = Object.create(
    RingtoneEngineBase.prototype
  );
...
(function() {
  ...
  var SoftphoneManager = function(softphoneParams) {
    ...
    var cleanMultipleSessions =
      "true" === softphoneParams.cleanMultipleSessions;
    var rtcSessions = {};
          ...
          for (var _connectionId in rtcSessions) {
            if (rtcSessions.hasOwnProperty(_connectionId)) {
              publishMultipleSessionsEvent(
                ...
                rtcSessions[_connectionId].callId,
                _connectionId
              );
            }
          }
  ...
  var publishError = function(errorType, message, endPointUrl) {
    var bus = connect.core.getEventBus();
    logger.error("Softphone error occurred : ", errorType, message || "");
    ...
    if (streamStats.length > 0) {
      contact.sendSoftphoneMetrics(streamStats, {
        ...
        failure: function(data) {
          logger.error("sendSoftphoneMetrics failed.").withObject(data);
        }
      });
    }
  };
  ...
  var sendSoftphoneReport = function(
    ...
    contact.sendSoftphoneReport(callReport, {
      ...
      failure: function(data) {
        logger.error("sendSoftphoneReport failed.").withObject(data);
      }
    });
  };
...
(function() {
  ...
  WorkerClient.prototype._recordAPILatency = function(
    method,
    request_start,
    err
  ) {
  ...
  var ClientEngine = function() {
    ...
    this.conduit = new connect.Conduit(
      "AmazonConnectSharedWorker",
      null,
      this.multiplexer
    );
    ...
    this.conduit.onDownstream(connect.EventType.SEND_LOGS, function(
      logsToUpload
    ) {
      ...
      if (data.authToken && data.authToken !== self.initData.authToken) {
        ...
        if (!self.agentPolling) {
          ...
          connect
            .getLog()
            .info(
              "Not kicking off new agent polling, since there's already polling going on"
            );
        }
        if (!self.configPolling) {
          ...
          connect
            .getLog()
            .info(
              "Not kicking off new config polling, since there's already polling going on"
            );
        }
        if (!global.checkAuthTokenInterval) {
          connect.getLog().info("Kicking off auth token polling");
          global.checkAuthTokenInterval = global.setInterval(
            connect.hitch(self, self.checkAuthToken),
            CHECK_AUTH_TOKEN_INTERVAL_MS
          );
        } else {
          connect
            .getLog()
            .info(
              "Not kicking off auth token polling, since there's already polling going on"
            );
        }
      }
    });
    ...
    global.onconnect = function(event) {
      ...
      portConduit.onDownstream(
        ...
        connect.hitch(
          self,
          self.handleMasterRequest,
          portConduit,
          stream.getId()
        )
      );
      portConduit.onDownstream(
        connect.EventType.RELOAD_AGENT_CONFIGURATION,
      ...
      },
      {
        success: function(data) {
          try {
            ...
            self.agent.snapshot.skew =
              self.agent.snapshot.snapshotTimestamp -
              self.agent.snapshot.localTimestamp;
            self.nextToken = data.nextToken;
            connect
              .getLog()
              .trace("GET_AGENT_SNAPSHOT succeeded.")
              .withObject(data);
            self.updateAgent();
          } catch (e) {
            connect
              .getLog()
              .error("Long poll failed to update agent.")
              .withObject(data)
              .withException(e);
          } finally {
            global.setTimeout(
              connect.hitch(self, self.pollForAgent),
              GET_AGENT_SUCCESS_TIMEOUT_MS
            );
          }
        },
        failure: function(err, data) {
      ...
      {},
      {
        success: function(data) {
          ...
          if (params.repeatForever) {
            global.setTimeout(
              connect.hitch(self, self.pollForAgentConfiguration, params),
        ...
        failure: function(err, data) {
          try {
            connect
              .getLog()
              .error("Failed to fetch agent configuration data.")
              .withObject({
                err: err,
                data: data
              });
  ...
  ClientEngine.prototype.pollForAgentStates = function(
    configuration,
    paramsIn
  ) {
    var self = this;
      ...
      },
      {
        success: function(data) {
          if (data.nextToken) {
            ...
            configuration.agentStates = (params.states || []).concat(
              data.states
            );
        ...
        failure: function(err, data) {
          connect
            .getLog()
            .error("Failed to fetch agent states list.")
            .withObject({
              err: err,
              data: data
            });
  ...
  ClientEngine.prototype.pollForAgentPermissions = function(
    configuration,
    paramsIn
  ) {
    var self = this;
      ...
      },
      {
        success: function(data) {
          if (data.nextToken) {
            ...
            configuration.permissions = (params.permissions || []).concat(
              data.permissions
            );
            self.updateAgentConfiguration(configuration);
          }
        ...
        failure: function(err, data) {
          connect
            .getLog()
            .error("Failed to fetch agent permissions list.")
            .withObject({
              err: err,
              data: data
            });
  ...
  ClientEngine.prototype.pollForDialableCountryCodes = function(
    configuration,
    paramsIn
  ) {
    var self = this;
    ...
    this.client.call(
      ...
      },
      {
        success: function(data) {
          if (data.nextToken) {
            self.pollForDialableCountryCodes(configuration, {
              countryCodes: (params.countryCodes || []).concat(
                data.countryCodes
              ),
              nextToken: data.nextToken,
              maxResults: params.maxResults
        ...
        failure: function(err, data) {
          connect
            .getLog()
            .error("Failed to fetch dialable country codes list.")
            .withObject({
              err: err,
              data: data
            });
  ...
  ClientEngine.prototype.pollForRoutingProfileQueues = function(
    configuration,
    paramsIn
  ) {
    var self = this;
      ...
      },
      {
        success: function(data) {
          if (data.nextToken) {
            ...
            configuration.routingProfile.queues = (params.queues || []).concat(
              data.queues
            );
            self.updateAgentConfiguration(configuration);
          }
        ...
        failure: function(err, data) {
          connect
            .getLog()
            .error("Failed to fetch routing profile queues list.")
            .withObject({
              err: err,
              data: data
            });
  ...
  ClientEngine.prototype.handleAPIRequest = function(portConduit, request) {
    ...
    this.client.call(request.method, request.params, {
      success: function(data) {
        var response = connect.EventFactory.createResponse(
          connect.EventType.API_RESPONSE,
          request,
          data
        );
      ...
      failure: function(err, data) {
        ...
        connect
          .getLog()
          .error("'%s' API request failed: %s", request.method, err)
          .withObject({
   ...
   */
  ClientEngine.prototype.handleMasterRequest = function(
    portConduit,
    portId,
    request
  ) {
    ...
    switch (request.method) {
      case connect.MasterMethods.BECOME_MASTER:
        ...
        response = connect.EventFactory.createResponse(
          connect.EventType.MASTER_RESPONSE,
          request,
          {
            masterId: portId,
  ...
  ClientEngine.prototype.updateAgentConfiguration = function(configuration) {
    if (
      ...
      connect
        .getLog()
        .trace(
          "Waiting to update agent configuration until all config data has been fetched."
        );
    }
  };
  ...
  ClientEngine.prototype.updateAgent = function() {
    if (!this.agent) {
      connect
        .getLog()
        .trace(
          "Waiting to update agent until the agent has been fully constructed."
        );
    } else if (!this.agent.snapshot) {
      connect
        .getLog()
        .trace(
          "Waiting to update agent until the agent snapshot is available."
        );
    } else if (!this.agent.configuration) {
      connect
        .getLog()
        .trace(
          "Waiting to update agent until the agent configuration is available."
        );
    } else {
      ...
      connect
        ...
        .info(
          "Auth token expires at " +
            expirationDate +
            " Start refreshing token with retry."
        );
      connect.backoff(
        connect.hitch(self, self.refreshAuthToken),
        REFRESH_AUTH_TOKEN_INTERVAL_MS,
        REFRESH_AUTH_TOKEN_MAX_TRY
      );
    }
  };
  ...
  ClientEngine.prototype.refreshAuthToken = function(callbacks) {
    ...
    this.client.call(
      connect.ClientMethods.GET_NEW_AUTH_TOKEN,
      { refreshToken: self.initData.refreshToken },
      {
        success: function(data) {
          connect
            .getLog()
            .info(
              "Get new auth token succeeded. New auth token expired at %s",
